...
public class ShowRoomListRoomsWhenIsOwnerUITest {
	...
	@Test
	public void testShowRoomListRoomsUI() throws Exception {
		...
		Assert.assertEquals("Rooms", this.driver.findElement(By.xpath("//h2")).getText());
	}
