...
public class SeeMyCausesUITest {
	...
	public void testVerMisCausas() throws Exception {
		...
		Assert.assertEquals("owner1", this.driver.findElement(By.xpath("//table[@id='causesTable']/tbody/tr/td")).getText());

		String usuario = this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul[2]/li/a/strong")).getText();
		String usuarioLower = usuario.toLowerCase();
		String creador = this.driver.findElement(By.xpath("//table[@id='causesTable']/tbody/tr/td")).getText();
		Assert.assertEquals(true, creador.equals(usuarioLower));
