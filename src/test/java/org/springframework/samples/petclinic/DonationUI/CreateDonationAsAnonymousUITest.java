...
public class CreateDonationAsAnonymousUITest {
  ...
  public void testCreateDonationAsAnonymousUI() throws Exception {
    ...
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("Anonymous", driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td")).getText());
    assertEquals("5.0", driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td[2]")).getText());
