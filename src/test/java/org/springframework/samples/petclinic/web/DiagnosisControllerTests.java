...
class DiagnosisControllerTests {
	...
	void testProcessCreationFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/vet/{vetId}/diagnosis?visitId={visitId}", DiagnosisControllerTests.TEST_VET_ID, DiagnosisControllerTests.TEST_VISIT_ID).param("description", "Prueba").param("date", "2025/03/15")
	...
	void testProcessCreationFormHasErrors() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/vet/{vetId}/diagnosis?visitId={visitId}", DiagnosisControllerTests.TEST_VET_ID, DiagnosisControllerTests.TEST_VISIT_ID).with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "Prueba"))
