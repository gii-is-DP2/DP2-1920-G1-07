...
public class CreateDonationAsAnonymousUITest {
	...
	@Test
	public void testCreateDonationAsAnonymousUI() throws Exception {
		...
		new Select(this.driver.findElement(By.id("anonymous"))).selectByVisibleText("true");
		this.driver.findElement(By.xpath("//option[@value='true']")).click();
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("Anonymous", this.driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td")).getText());
		Assert.assertEquals("5.0", this.driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td[2]")).getText());
		this.driver.findElement(By.xpath("(//a[contains(text(),'Delete')])[4]")).click();
