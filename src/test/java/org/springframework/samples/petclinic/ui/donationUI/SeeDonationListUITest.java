...
public class SeeDonationListUITest {
	...
	public void testSeeDonationListUI() throws Exception {
		...
		this.driver.findElement(By.linkText("See My Donations")).click();
		Assert.assertEquals("admin1", this.driver.findElement(By.xpath("//table[@id='DonationsTable']/tbody/tr/td")).getText());
		Assert.assertEquals("admin1", this.driver.findElement(By.xpath("//table[@id='DonationsTable']/tbody/tr[2]/td")).getText());
		Assert.assertEquals("admin1", this.driver.findElement(By.xpath("//table[@id='DonationsTable']/tbody/tr[3]/td")).getText());
