...
public class CreateDonationUITest {
	...
	@Test
	public void testCreateDonationUI() throws Exception {
		...
		this.driver.findElement(By.id("money")).sendKeys("0.1");
		...
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("admin1", this.driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td")).getText());
		Assert.assertEquals("0.1", this.driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td[2]")).getText());
