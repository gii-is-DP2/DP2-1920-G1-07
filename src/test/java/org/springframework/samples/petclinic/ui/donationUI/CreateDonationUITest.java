...
//		System.setProperty("webdriver.gecko.driver", pathToGeckoDriver + "\\geckodriver.exe");
	...
	public void testCreateDonationUI() throws Exception {
		...
		driver.findElement(By.id("money")).sendKeys("0.1");
		...
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		assertEquals("admin1", driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td")).getText());
		assertEquals("0.1", driver.findElement(By.xpath("//table[@id='donationsTable']/tbody/tr[4]/td[2]")).getText());
