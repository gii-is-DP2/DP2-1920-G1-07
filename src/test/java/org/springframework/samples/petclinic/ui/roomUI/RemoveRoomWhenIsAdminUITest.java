...
public class RemoveRoomWhenIsAdminUITest {
	...
	public void testRemoveRoomWhereIsAdminUI() throws Exception {
		...
		this.driver.findElement(By.linkText("Room9")).click();
		Assert.assertEquals("Delete Room", this.driver.findElement(By.linkText("Delete Room")).getText());
		this.driver.findElement(By.linkText("Delete Room")).click();
		Assert.assertEquals("Room2", this.driver.findElement(By.linkText("Room2")).getText());
	}
